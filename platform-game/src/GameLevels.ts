 ...
 * @since Apr 27 2026
 * @desc Contains the predefined level layouts that drive stage generation and
 * entity placement across the game.
 */

/** @desc Array of level designs defining the game's world layouts. */
